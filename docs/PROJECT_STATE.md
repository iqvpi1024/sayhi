...
**v0.3.3-beta 已发布（2026-08-08）；Change Control 遗留已清零（§3 第 84 条：changesets.py 动态 revision 分配 + c1 rebind，episodes.py 评估后保留并留痕，版本号单一来源），26 个 suite validator 与全量回归 525 OK 0 skipped 全绿。下一步：无未决工程遗留；持续关注公开后的外部反馈与安全问题响应，真实 Agent 接入反馈优先迭代。**

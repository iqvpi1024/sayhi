...
def main() -> int:
    ...
    if errors:
        for error in errors:
            print(f"ERROR: {error}")
        return 1
    print("PASSED: Y2S1 suite materialized and current business runner result is bound" if flags == passed_flags else "PASSED: Y2S1 suite materialization preflight; no business test was executed")
    return 0

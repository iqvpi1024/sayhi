...
ROLES = {"fixture", "oracle", "scenario_plan", "adapter_protocol", "business_test_module", "storage_tests", "episode_changeset_tests", "offline_runner", "suite_preflight_validator"}
